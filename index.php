<?php
ob_start();
define('https://api.telegram.org/bot1206351513:AAG5qE1VIEe1Yv_ONc3dVToSRkOp4XpeH4s/setwebhook?url=https://nurmanov.herokuapp.com','1206351513:AAG5qE1VIEe1Yv_ONc3dVToSRkOp4XpeH4s');
...
$balinfo = "🚀 Salom $name, @Uzbek_Paynet_Bot ga hush kelibsiz
...
Namuna: /pay +998xxxxxxxxx 10000

⚠ Eng oz chiqaraladigan summa: 10000 so'm",
'parse_mode'=>'markdown',
...
Guruximizga kirasiz guruximizga 50 ta odam qo'shsangiz bot hisobingizga 5000 so'm qo'shiladi mamnuniyat ila @Uzbek_Paynet_Bot",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"Guruximiz","url"=>"t.me/Uzbek_Paynet_Chat"]],
]
])
]);
}
...
if($tx=="📢 Reklama qilish"){
    bot('sendmessage',[
        'chat_id'=>$cid,
        'text'=>"Siz kanal yoki gurupa yoki botingizni reklama qildirmoqchimisiz unda @X_Aloqa_Bot ga muro'jat qiling!"
...
https://t.me/Uzbek_Paynet_bot?start=$cid
...
Har bir do'stingiz uchun 500 so'mni qo'lga kiring",
      'reply_markup'=>json_encode([
   'inline_keyboard'=>[
       [['text'=>"1-Kanalimiz","url"=>"t.me/DASTURLAR_PLAYMARKET_OYINLAR"]],
       [['text'=>"2-Kanalimiz","url"=>"t.me/Uzbek_Paynet_Pay"]],
...
📡 Kanalga Qarang: @Uzbek_Paynet_Pay"
        ]);
}
if($data=="UZ"){
    $gett = bot('getChatMember',[
  ...
  if($gget == "member" or $gget == "creator" or $gget == "administrator"){
    bot('deletemessage',[
        ...
        bot('sendmessage',[
        'chat_id'=>$callcid,
        'text'=>"✅ Kanalimizga Ulandingiz. endi pul mummkin.",
        'reply_markup'=>$key,
        ]);
